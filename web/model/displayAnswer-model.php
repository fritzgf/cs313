...
$query = "SELECT a.id, a.answer, a.date, a.user_id, u.firstname FROM answers as a INNER JOIN users as u ON a.user_id= u.id WHERE a.id=:user_id ORDER BY date DESC";
$statement = $db->prepare($query);
